# Chrono Trigger Cutscene Remover ROM Hack
An IPS patch for SNES Chrono Trigger to create a version of the ROM with cutscenes removed

The current focus is on the Any% speedrun route and associated cutscenes. This is mostly done up until Reptite Lair although it has not been thoroughly tested.
